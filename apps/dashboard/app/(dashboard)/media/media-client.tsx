...
/**
 * Client component for media page.
 * Receives server-fetched data for instant render.
 * @param props - initialMedia, permissions
 */
export const MediaClient = ({
	...
	const { data: freshItems, refetch: refetchMedia } = useCachedFetch<MediaItem[]>('/api/media');
	const items = freshItems ?? initialMedia;
	...
	const canUpload = hasPerm(permissions, 'media', 'create');
	const canDeleteMedia = hasPerm(permissions, 'media', 'delete');
